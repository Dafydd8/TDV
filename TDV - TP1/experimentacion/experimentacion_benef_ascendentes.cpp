...
int main(){
    ...
    vector<int> pesos = {918, 591, 735, 592, 76, 683, 704, 363, 262, 492};
    vector<int> beneficios = {98, 221, 347, 459, 581, 718, 903, 1059, 1192, 1198};
    vector<int> s;
    ...
    std::ofstream archivo("benef_ascendentes.csv");
    if (!archivo.is_open()) {
