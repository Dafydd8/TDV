...
int main(){
    ...
    vector<int> pesos = {76, 200, 345, 226, 269, 244, 144, 278, 363, 296};
    vector<int> beneficios = {673, 641, 459, 789, 551, 746, 522, 271, 525, 448};
    vector<int> s;
    ...
    std::ofstream archivo("pesosB_benfN_4M.csv");
    if (!archivo.is_open()) {
