...
int main(){
    ...
    /*
    vector<int> pesos = {150,300,200,100,200};
    vector<int> beneficios = {393, 335, 242, 348, 269};
    */
    vector<int> pesos = {50,70,10,60,80,50,50,70,10,60};
    vector<int> beneficios = {224, 301, 184, 452, 164, 304, 19, 118, 346, 288};
    vector<int> s;
    ...
    std::ofstream archivo("todas_entran_10.csv");
    if (!archivo.is_open()) {
