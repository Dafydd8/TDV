...
int main(){
    ...
    vector<int> pesos = {548, 423, 279, 744, 442}; // media 600
    vector<int> beneficios = {301, 797, 479, 525, 490}; // media 500
    vector<int> s;    
    ...
    for (int i = 0 ; i < 1 ; i++){
        ...
        */
        ...
        dp.clear();
        cout << resultado_pd << endl;
        best_solution.clear();
        cout<< "all done" << endl;
    }
/*
    std::ofstream archivo("pesosA_4M.csv");
    if (!archivo.is_open()) {
